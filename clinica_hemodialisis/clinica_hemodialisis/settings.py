"""
Django settings for clinica_hemodialisis project.
...
SECRET_KEY = 'django-insecure-bpf2wsfqfutbi#0mj_dxsgs(20q4u4sp#lyaj@z9r_8kn6y088'
...
ROOT_URLCONF = 'clinica_hemodialisis.urls'
...
WSGI_APPLICATION = 'clinica_hemodialisis.wsgi.application'
